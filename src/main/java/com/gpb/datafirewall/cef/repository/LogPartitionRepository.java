package com.gpb.datafirewall.cef.repository;
...
import com.gpb.datafirewall.cef.properties.CleanDatabaseLogsProperties;
...
/**
 * Класс для создания и удаления старых партиций в базе аудита
 */
@Slf4j
@Repository
